package models.escenarios.pantallaGano;
...
public class scenaGano extends Scene {
    ...
    public void content(){
        ...
        fondo.setImage(new Image(this.getClass().getResource("win.gif").toExternalForm()));
